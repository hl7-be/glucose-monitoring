# Use case 5.3 (Days sensor worn Observation) - HL7 FHIR Implementation Guide: Glucose Monitoring v1.0.0

## Example Observation: Use case 5.3 (Days sensor worn Observation)
