...
Logical model representing a diabetes diagnostic report based on glucose monitoring data. 
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "Logical model representing a diabetes diagnostic report based on glucose monitoring data."
    },
    {
