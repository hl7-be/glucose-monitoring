...
Belgian FHIR profile for a diabetes diagnostic report based on glucose monitoring data. 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "patternUri" : "https://www.ehealth.fgov.be/standards/fhir/glucose-monitoring/NamingSystem/be-ns-diabetes-device-type"
    },
    {
